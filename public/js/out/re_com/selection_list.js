...
var args16237 = [];
var len__6047__auto___16240 = arguments.length;
var i__6048__auto___16241 = (0);
while(true){
if((i__6048__auto___16241 < len__6047__auto___16240)){
args16237.push((arguments[i__6048__auto___16241]));

var G__16242 = (i__6048__auto___16241 + (1));
i__6048__auto___16241 = G__16242;
continue;
} else {
}
break;
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__16247){
var map__16250 = p__16247;
var map__16250__$1 = ((((!((map__16250 == null)))?((((map__16250.cljs$lang$protocol_mask$partition0$ & (64))) || (map__16250.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16250):map__16250);
var args = map__16250__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__16250__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__16250,map__16250__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__16244_SHARP_){
return item_renderer.call(null,p1__16244_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__16250,map__16250__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__16250,map__16250__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__16245_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__16245_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__16250,map__16250__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__16250,map__16250__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__16246_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__16246_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__16250,map__16250__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__6047__auto___16259 = arguments.length;
var i__6048__auto___16260 = (0);
while(true){
if((i__6048__auto___16260 < len__6047__auto___16259)){
args__6054__auto__.push((arguments[i__6048__auto___16260]));

var G__16261 = (i__6048__auto___16260 + (1));
i__6048__auto___16260 = G__16261;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__16253){
var map__16254 = p__16253;
var map__16254__$1 = ((((!((map__16254 == null)))?((((map__16254.cljs$lang$protocol_mask$partition0$ & (64))) || (map__16254.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16254):map__16254);
var args = map__16254__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"validate-args-macro","validate-args-macro",-1576181756,null),new cljs.core.Symbol(null,"selection-list-args-desc","selection-list-args-desc",-219283300,null),new cljs.core.Symbol(null,"args","args",-1338879193,null),"selection-list")))].join('')));
}

return ((function (map__16254,map__16254__$1,args){
return (function() { 
var G__16262__delegate = function (p__16256){
...
while (G__16263__i < G__16263__a.length) {G__16263__a[G__16263__i] = arguments[G__16263__i + 0]; ++G__16263__i;}
  p__16256 = new cljs.core.IndexedSeq(G__16263__a,0);
} 
return G__16262__delegate.call(this,p__16256);};
G__16262.cljs$lang$maxFixedArity = 0;
G__16262.cljs$lang$applyTo = (function (arglist__16264){
var p__16256 = cljs.core.seq(arglist__16264);
return G__16262__delegate(p__16256);
});
G__16262.cljs$core$IFn$_invoke$arity$variadic = G__16262__delegate;
return G__16262;
})()
;
;})(map__16254,map__16254__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq16252){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16252));
});
