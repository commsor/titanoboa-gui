...
return cljs.core.assoc.call(null,p1__16245_SHARP_,p2__16246_SHARP_,reagent.core.atom.call(null,false));
});})(tour_map))
,tour_map,tour_spec);
});
/**
...
return cljs.core.doall.call(null,(function (){var iter__5761__auto__ = (function re_com$tour$initialise_tour_$_iter__16251(s__16252){
return (new cljs.core.LazySeq(null,(function (){
var s__16252__$1 = s__16252;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__16252__$1);
if(temp__4425__auto__){
var s__16252__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__16252__$2)){
var c__5759__auto__ = cljs.core.chunk_first.call(null,s__16252__$2);
var size__5760__auto__ = cljs.core.count.call(null,c__5759__auto__);
var b__16254 = cljs.core.chunk_buffer.call(null,size__5760__auto__);
if((function (){var i__16253 = (0);
while(true){
if((i__16253 < size__5760__auto__)){
var step = cljs.core._nth.call(null,c__5759__auto__,i__16253);
cljs.core.chunk_append.call(null,b__16254,cljs.core.reset_BANG_.call(null,step.call(null,tour),false));

var G__16255 = (i__16253 + (1));
i__16253 = G__16255;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__16254),re_com$tour$initialise_tour_$_iter__16251.call(null,cljs.core.chunk_rest.call(null,s__16252__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__16254),null);
}
} else {
var step = cljs.core.first.call(null,s__16252__$2);
return cljs.core.cons.call(null,cljs.core.reset_BANG_.call(null,step.call(null,tour),false),re_com$tour$initialise_tour_$_iter__16251.call(null,cljs.core.rest.call(null,s__16252__$2)));
}
} else {
return null;
}
