...
return cljs.core.swap_BANG_.call(null,user,cljs.core.assoc,new cljs.core.Keyword(null,"name","name",1843675177),p1__10959_SHARP_.target.value);
});})(user))
...
return cljs.core.swap_BANG_.call(null,user,cljs.core.assoc,new cljs.core.Keyword(null,"password","password",417022471),p1__10960_SHARP_.target.value);
});})(user))
...
return cljs.core.reset_BANG_.call(null,titanoboa.core.user_data,p1__10961_SHARP_);
});})(user))
);
...
titanoboa.api.get_user.call(null,(function (p1__10962_SHARP_){
return cljs.core.reset_BANG_.call(null,titanoboa.core.user_data,p1__10962_SHARP_);
}));
titanoboa.core.load_data.call(null);
