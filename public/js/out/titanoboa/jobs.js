...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.label","span.label",-1921107865),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__10926 = (((status instanceof cljs.core.Keyword))?status.fqn:null);
switch (G__10926) {
case "running":
...
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.glyphicon","span.glyphicon",-1068520797),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__10927 = (((status instanceof cljs.core.Keyword))?status.fqn:null);
switch (G__10927) {
case "running":
...
})(),new cljs.core.Keyword(null,"style","style",-496642736),(function (){var G__10928 = (((status instanceof cljs.core.Keyword))?status.fqn:null);
switch (G__10928) {
case "finished":
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [titanoboa.designer.select_picker,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"key","key",-1516042587),"jobs-start-job-modal-jd-picker",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"5px"], null),new cljs.core.Keyword(null,"val","val",128701612),cljs.core.deref.call(null,job_name_atom),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__10932_SHARP_){
return cljs.core.reset_BANG_.call(null,job_name_atom,p1__10932_SHARP_.target.value);
...
return titanoboa.api.get_def.call(null,job_name,cljs.core.deref.call(null,revision_atom),(function (p1__10933_SHARP_){
return cljs.core.swap_BANG_.call(null,temp_props_atom,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [job_name,cljs.core.deref.call(null,revision_atom),new cljs.core.Keyword(null,"properties","properties",685819552)], null),new cljs.core.Keyword(null,"properties","properties",685819552).cljs$core$IFn$_invoke$arity$1(p1__10933_SHARP_));
}));
} else {
return null;
}
}),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Select Job definition's revision",new cljs.core.Keyword(null,"title","title",636505583),"Select Job definition's revision"], null),titanoboa.designer.select_options.call(null,cljs.core.sort.call(null,(function (p1__10935_SHARP_,p2__10934_SHARP_){
return cljs.core.compare.call(null,cljs.core.first.call(null,p2__10934_SHARP_),cljs.core.first.call(null,p1__10935_SHARP_));
...
cljs.core.reset_BANG_.call(null,titanoboa.jobs.available_job_defs_atom,p1__10936_SHARP_);
...
return cljs.core.reset_BANG_.call(null,titanoboa.jobs.available_job_defs_atom,p1__10937_SHARP_);
});})(temp_props_atom,editing_key,revision,selected_system,job_name))
);

var G__10943 = (((cljs.core.deref.call(null,titanoboa.jobs.active_tab) instanceof cljs.core.Keyword))?cljs.core.deref.call(null,titanoboa.jobs.active_tab).fqn:null);
switch (G__10943) {
case "recent":
return titanoboa.api.list_running_jobs.call(null,((function (G__10943,temp_props_atom,editing_key,revision,selected_system,job_name){
return (function (p1__10938_SHARP_){
return cljs.core.reset_BANG_.call(null,titanoboa.jobs.jobs_snapshot,cljs.core.merge_with.call(null,cljs.core.merge,titanoboa.jobs.get_opened_snapshots.call(null),p1__10938_SHARP_));
});})(G__10943,temp_props_atom,editing_key,revision,selected_system,job_name))
);

break;
case "archived":
return titanoboa.api.list_archived_jobs.call(null,new cljs.core.Keyword(null,"limit","limit",-1355822363).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,titanoboa.jobs.archived_jobs_list)),new cljs.core.Keyword(null,"offset","offset",296498311).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,titanoboa.jobs.archived_jobs_list)),cljs.core.deref.call(null,titanoboa.jobs.sort_order),((function (G__10943,temp_props_atom,editing_key,revision,selected_system,job_name){
return (function (p1__10939_SHARP_){
return cljs.core.reset_BANG_.call(null,titanoboa.jobs.archived_jobs_list,p1__10939_SHARP_);
});})(G__10943,temp_props_atom,editing_key,revision,selected_system,job_name))
,((function (G__10943,temp_props_atom,editing_key,revision,selected_system,job_name){
return (function (){
...
return cljs.core.reset_BANG_.call(null,selected_system,titanoboa.util.s__GT_key.call(null,p1__10940_SHARP_.target.value));
});})(temp_props_atom,editing_key,revision,selected_system,job_name))
...
return cljs.core.swap_BANG_.call(null,temp_props_atom,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.deref.call(null,job_name),cljs.core.deref.call(null,revision),new cljs.core.Keyword(null,"properties","properties",685819552)], null),new cljs.core.Keyword(null,"properties","properties",685819552).cljs$core$IFn$_invoke$arity$1(p1__10941_SHARP_));
});})(temp_props_atom,editing_key,revision,selected_system,job_name))
);
});})(temp_props_atom,editing_key,revision,selected_system,job_name))
...
break;
case "logs":
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table.table.table-striped.table-hover","table.table.table-striped.table-hover",726875574),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tbody","tbody",-80678300),cljs.core.sequence.call(null,cljs.core.map.call(null,((function (G__10946,graph_cursor,jd_cursor,job_cursor,tab_selected){
return (function (i){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(cljs.core.truth_(new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(i))?new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(i):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"b","b",1482224470),new cljs.core.Keyword(null,"exception","exception",-335277064).cljs$core$IFn$_invoke$arity$1(i)], null))], null)], null);
});})(G__10946,graph_cursor,jd_cursor,job_cursor,tab_selected))
,cljs.core.filter.call(null,((function (G__10946,graph_cursor,jd_cursor,job_cursor,tab_selected){
return (function (i){
...
return (function (p1__10949_SHARP_){
return cljs.core.reset_BANG_.call(null,titanoboa.jobs.archived_jobs_list,p1__10949_SHARP_);
});})(sys_selected))
...
,titanoboa.jobs.pagination_range.call(null,cljs.core.quot.call(null,new cljs.core.Keyword(null,"offset","offset",296498311).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,titanoboa.jobs.archived_jobs_list)),titanoboa.jobs.archive_page_size),Math.ceil((new cljs.core.Keyword(null,"totalcount","totalcount",-227730219).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,titanoboa.jobs.archived_jobs_list)) / new cljs.core.Keyword(null,"limit","limit",-1355822363).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,titanoboa.jobs.archived_jobs_list)))),(5))))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.panel.panel-default","div.panel.panel-default",-1039051133),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"overflow-y","overflow-y",-1436589285),"scroll",new cljs.core.Keyword(null,"height","height",1025178622),(cljs.core.deref.call(null,titanoboa.designer.win_height_atom) - (195))], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table.table.table-striped.table-hover","table.table.table-striped.table-hover",726875574),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"thead","thead",-291875296),new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Job ID"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Job Template"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Status"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Started"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Duration"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Last Step"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Step Status"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Action"], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tbody","tbody",-80678300),cljs.core.sequence.call(null,titanoboa.jobs.render_rows_trdcr.call(null,titanoboa.jobs.load_archived_job),new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,titanoboa.jobs.archived_jobs_list)))], null)], null)], null)], null)], null))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.jobs-tab.col.jobs-details","div.jobs-tab.col.jobs-details",-62639376),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.nav.nav-tabs","ul.nav.nav-tabs",1865557319),cljs.core.doall.call(null,cljs.core.map.call(null,((function (sys_selected){
...
titanoboa.api.list_running_jobs.call(null,(function (p1__10954_SHARP_){
return cljs.core.reset_BANG_.call(null,titanoboa.jobs.jobs_snapshot,cljs.core.merge_with.call(null,cljs.core.merge,titanoboa.jobs.get_opened_snapshots.call(null),p1__10954_SHARP_));
}));
titanoboa.api.list_archived_jobs.call(null,titanoboa.jobs.archive_page_size,(0),cljs.core.deref.call(null,titanoboa.jobs.sort_order),(function (p1__10955_SHARP_){
return cljs.core.reset_BANG_.call(null,titanoboa.jobs.archived_jobs_list,p1__10955_SHARP_);
}),(function (){
cljs.core.reset_BANG_.call(null,titanoboa.jobs.archive_disabled_QMARK_,true);

return cljs.core.reset_BANG_.call(null,titanoboa.jobs.active_tab,new cljs.core.Keyword(null,"recent","recent",449517715));
}));
titanoboa.api.list_all_defs.call(null,(function (p1__10956_SHARP_){
return cljs.core.reset_BANG_.call(null,titanoboa.jobs.available_job_defs_atom,p1__10956_SHARP_);
}));
