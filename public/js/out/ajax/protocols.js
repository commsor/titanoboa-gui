...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5605__auto__,k11759,else__5606__auto__){
var self__ = this;
var this__5605__auto____$1 = this;
var G__11761 = (((k11759 instanceof cljs.core.Keyword))?k11759.fqn:null);
switch (G__11761) {
case "status":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k11759,else__5606__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__11758){
var self__ = this;
var G__11758__$1 = this;
return (new cljs.core.RecordIter((0),G__11758__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5610__auto__,k__5611__auto__,G__11758){
var self__ = this;
var this__5610__auto____$1 = this;
var pred__11762 = cljs.core.keyword_identical_QMARK_;
var expr__11763 = k__5611__auto__;
if(cljs.core.truth_(pred__11762.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__11763))){
return (new ajax.protocols.Response(G__11758,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11762.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__11763))){
return (new ajax.protocols.Response(self__.status,G__11758,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11762.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__11763))){
return (new ajax.protocols.Response(self__.status,self__.body,G__11758,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11762.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__11763))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__11758,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11762.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__11763))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__11758,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5611__auto__,G__11758),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5602__auto__,G__11758){
var self__ = this;
var this__5602__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__11758,self__.__extmap,self__.__hash));
});
...
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__11760){
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__11760),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__11760),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__11760),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__11760),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__11760),null,cljs.core.dissoc.call(null,G__11760,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)),null));
});
