...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"text","text",-1790561697),(function (p__11056){
var vec__11057 = p__11056;
var _ = cljs.core.nth.call(null,vec__11057,(0),null);
var text = cljs.core.nthnext.call(null,vec__11057,(1));
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"pass","pass",1574159993),(function (p__11058){
var vec__11059 = p__11058;
var _ = cljs.core.nth.call(null,vec__11059,(0),null);
var text = cljs.core.nthnext.call(null,vec__11059,(1));
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"escaped","escaped",-1007929769),(function (p__11060){
var vec__11061 = p__11060;
var _ = cljs.core.nth.call(null,vec__11061,(0),null);
var text = cljs.core.nth.call(null,vec__11061,(1),null);
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"span","span",1394872991),(function (p__11062){
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"line","line",212345235),(function (p__11064){
var vec__11065 = p__11064;
var _ = cljs.core.nth.call(null,vec__11065,(0),null);
var inline = cljs.core.nth.call(null,vec__11065,(1),null);
var terminate = cljs.core.nth.call(null,vec__11065,(2),null);
...
var G__11066__delegate = function (_){
...
while (G__11067__i < G__11067__a.length) {G__11067__a[G__11067__i] = arguments[G__11067__i + 0]; ++G__11067__i;}
  _ = new cljs.core.IndexedSeq(G__11067__a,0);
} 
return G__11066__delegate.call(this,_);};
G__11066.cljs$lang$maxFixedArity = 0;
G__11066.cljs$lang$applyTo = (function (arglist__11068){
var _ = cljs.core.seq(arglist__11068);
return G__11066__delegate(_);
});
G__11066.cljs$core$IFn$_invoke$arity$variadic = G__11066__delegate;
return G__11066;
})()
);
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"group","group",582596132),(function (p__11069){
var vec__11070 = p__11069;
var _ = cljs.core.nth.call(null,vec__11070,(0),null);
var children = cljs.core.nthnext.call(null,vec__11070,(1));
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"nest","nest",-314993663),(function (p__11071){
var vec__11072 = p__11071;
var _ = cljs.core.nth.call(null,vec__11072,(0),null);
var args = cljs.core.nthnext.call(null,vec__11072,(1));
var vec__11073 = ((typeof cljs.core.first.call(null,args) === 'number')?args:cljs.core.cons.call(null,(2),args));
var offset = cljs.core.nth.call(null,vec__11073,(0),null);
var children = cljs.core.nthnext.call(null,vec__11073,(1));
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"align","align",1964212802),(function (p__11074){
var vec__11075 = p__11074;
var _ = cljs.core.nth.call(null,vec__11075,(0),null);
var args = cljs.core.nthnext.call(null,vec__11075,(1));
var vec__11076 = ((typeof cljs.core.first.call(null,args) === 'number')?args:cljs.core.cons.call(null,(0),args));
var offset = cljs.core.nth.call(null,vec__11076,(0),null);
...
var G__11079__1 = (function (res){
return rf.call(null,res);
});
var G__11079__2 = (function (res,node){
var delta = (function (){var G__11078 = (((new cljs.core.Keyword(null,"op","op",-1882987955).cljs$core$IFn$_invoke$arity$1(node) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"op","op",-1882987955).cljs$core$IFn$_invoke$arity$1(node).fqn:null);
switch (G__11078) {
case "text":
...
G__11079 = function(res,node){
switch(arguments.length){
case 0:
return G__11079__0.call(this);
case 1:
return G__11079__1.call(this,res);
case 2:
return G__11079__2.call(this,res,node);
}
...
var len__6047__auto___11084 = arguments.length;
var i__6048__auto___11085 = (0);
while(true){
if((i__6048__auto___11085 < len__6047__auto___11084)){
args__6054__auto__.push((arguments[i__6048__auto___11085]));

var G__11086 = (i__6048__auto___11085 + (1));
i__6048__auto___11085 = G__11086;
continue;
} else {
}
break;
...
fipp.engine.update_right.cljs$lang$applyTo = (function (seq11081){
...
return fipp.engine.update_right.cljs$core$IFn$_invoke$arity$variadic(G__11082,G__11083,seq11081__$2);
});
/**
 ...
 */
fipp.engine.annotate_begins = (function fipp$engine$annotate_begins(p__11087){
var map__11093 = p__11087;
...
var options = map__11093__$1;
var width = cljs.core.get.call(null,map__11093__$1,new cljs.core.Keyword(null,"width","width",-384071477));
return ((function (map__11093,map__11093__$1,options,width){
return (function (rf){
var pos = cljs.core.volatile_BANG_.call(null,(0));
var bufs = cljs.core.volatile_BANG_.call(null,fipp.deque.empty);
return ((function (pos,bufs,map__11093,map__11093__$1,options,width){
return (function() {
var G__11098 = null;
var G__11098__0 = (function (){
return rf.call(null);
});
var G__11098__1 = (function (res){
return rf.call(null,res);
});
var G__11098__2 = (function (res,p__11095){
var map__11096 = p__11095;
var map__11096__$1 = ((((!((map__11096 == null)))?((((map__11096.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11096.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11096):map__11096);
var node = map__11096__$1;
var op = cljs.core.get.call(null,map__11096__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var right = cljs.core.get.call(null,map__11096__$1,new cljs.core.Keyword(null,"right","right",-452581833));
...
var G__11099 = buffers_STAR__STAR_;
var G__11100 = res_STAR___$1;
buffers_STAR_ = G__11099;
res__$1 = G__11100;
continue;
}
}
...
G__11098 = function(res,p__11095){
switch(arguments.length){
case 0:
return G__11098__0.call(this);
case 1:
return G__11098__1.call(this,res);
case 2:
return G__11098__2.call(this,res,p__11095);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__11098.cljs$core$IFn$_invoke$arity$0 = G__11098__0;
G__11098.cljs$core$IFn$_invoke$arity$1 = G__11098__1;
G__11098.cljs$core$IFn$_invoke$arity$2 = G__11098__2;
return G__11098;
})()
;})(pos,bufs,map__11093,map__11093__$1,options,width))
});
;})(map__11093,map__11093__$1,options,width))
});
/**
 * Given printing options, returns a transducer which produces the fully
 * laid-out strings.
 */
fipp.engine.format_nodes = (function fipp$engine$format_nodes(p__11101){
var map__11108 = p__11101;
...
var options = map__11108__$1;
var width = cljs.core.get.call(null,map__11108__$1,new cljs.core.Keyword(null,"width","width",-384071477));
return ((function (map__11108,map__11108__$1,options,width){
return (function (rf){
...
return ((function (fits,length,tab_stops,column,map__11108,map__11108__$1,options,width){
return (function() {
var G__11114 = null;
var G__11114__0 = (function (){
return rf.call(null);
});
var G__11114__1 = (function (res){
return rf.call(null,res);
});
var G__11114__2 = (function (res,p__11110){
...
var node = map__11111__$1;
var op = cljs.core.get.call(null,map__11111__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var right = cljs.core.get.call(null,map__11111__$1,new cljs.core.Keyword(null,"right","right",-452581833));
var indent = cljs.core.peek.call(null,cljs.core.deref.call(null,tab_stops));
var G__11113 = (((op instanceof cljs.core.Keyword))?op.fqn:null);
switch (G__11113) {
case "nest":
...
G__11114 = function(res,p__11110){
switch(arguments.length){
case 0:
return G__11114__0.call(this);
case 1:
return G__11114__1.call(this,res);
case 2:
return G__11114__2.call(this,res,p__11110);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
;})(fits,length,tab_stops,column,map__11108,map__11108__$1,options,width))
});
;})(map__11108,map__11108__$1,options,width))
});
fipp.engine.pprint_document = (function fipp$engine$pprint_document(document,options){
var options_11116__$1 = cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),(70)], null),options);
cljs.core.run_BANG_.call(null,cljs.core.print,cljs.core.eduction.call(null,fipp.engine.annotate_rights,fipp.engine.annotate_begins.call(null,options_11116__$1),fipp.engine.format_nodes.call(null,options_11116__$1),fipp.engine.serialize.call(null,document)));
