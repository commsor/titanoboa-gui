...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__11019,open,xs,sep,close,f){
var map__11023 = p__11019;
...
var printer = map__11023__$1;
var print_level = cljs.core.get.call(null,map__11023__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.call(null,map__11023__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__11025 = printer;
var G__11025__$1 = (cljs.core.truth_(print_level)?cljs.core.update.call(null,G__11025,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec):G__11025);
return G__11025__$1;
})();
var xform = cljs.core.comp.call(null,(cljs.core.truth_(print_length)?cljs.core.take.call(null,print_length):cljs.core.identity),cljs.core.map.call(null,((function (printer__$1,map__11023,map__11023__$1,printer,print_level,print_length){
return (function (p1__11018_SHARP_){
return f.call(null,printer__$1,p1__11018_SHARP_);
});})(printer__$1,map__11023,map__11023__$1,printer,print_level,print_length))
...
fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5605__auto__,k11027,else__5606__auto__){
var self__ = this;
var this__5605__auto____$1 = this;
var G__11029 = (((k11027 instanceof cljs.core.Keyword))?k11027.fqn:null);
switch (G__11029) {
case "symbols":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k11027,else__5606__auto__);
...
fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__11026){
var self__ = this;
var G__11026__$1 = this;
return (new cljs.core.RecordIter((0),G__11026__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__11030){
var self__ = this;
...
var tag = cljs.core.get.call(null,map__11031__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.call(null,map__11031__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
return (function (printer,p__11033){
...
fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5610__auto__,k__5611__auto__,G__11026){
var self__ = this;
var this__5610__auto____$1 = this;
var pred__11035 = cljs.core.keyword_identical_QMARK_;
var expr__11036 = k__5611__auto__;
if(cljs.core.truth_(pred__11035.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__11036))){
return (new fipp.edn.EdnPrinter(G__11026,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11035.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__11036))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__11026,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11035.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__11036))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__11026,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__11035.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__11036))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__11026,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5611__auto__,G__11026),null));
}
}
}
}
...
fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5602__auto__,G__11026){
var self__ = this;
var this__5602__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__11026,self__.__extmap,self__.__hash));
});
...
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__11028){
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__11028),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__11028),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__11028),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__11028),null,cljs.core.dissoc.call(null,G__11028,new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)),null));
});

fipp.edn.pprint = (function fipp$edn$pprint(){
var args11039 = [];
var len__6047__auto___11043 = arguments.length;
var i__6048__auto___11044 = (0);
while(true){
if((i__6048__auto___11044 < len__6047__auto___11043)){
args11039.push((arguments[i__6048__auto___11044]));

var G__11045 = (i__6048__auto___11044 + (1));
i__6048__auto___11044 = G__11045;
continue;
} else {
}
break;
...
var _STAR_print_meta_STAR_11042 = cljs.core._STAR_print_meta_STAR_;
cljs.core._STAR_print_meta_STAR_ = false;

try{return fipp.engine.pprint_document.call(null,fipp.visit.visit.call(null,printer,x),options);
}finally {cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR_11042;
}});
