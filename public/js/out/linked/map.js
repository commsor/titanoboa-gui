...
linked.map.Node.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5605__auto__,k13021,else__5606__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k13021,else__5606__auto__);
...
linked.map.Node.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5610__auto__,k__5611__auto__,G__13020){
var self__ = this;
var this__5610__auto____$1 = this;
var pred__13024 = cljs.core.keyword_identical_QMARK_;
var expr__13025 = k__5611__auto__;
if(cljs.core.truth_(pred__13024.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__13025))){
return (new linked.map.Node(G__13020,self__.left,self__.right,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__13024.call(null,new cljs.core.Keyword(null,"left","left",-399115937),expr__13025))){
return (new linked.map.Node(self__.value,G__13020,self__.right,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__13024.call(null,new cljs.core.Keyword(null,"right","right",-452581833),expr__13025))){
return (new linked.map.Node(self__.value,self__.left,G__13020,self__.__meta,self__.__extmap,null));
} else {
return (new linked.map.Node(self__.value,self__.left,self__.right,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5611__auto__,G__13020),null));
}
}
}
});
...
linked.map.Node.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5602__auto__,G__13020){
var self__ = this;
var this__5602__auto____$1 = this;
return (new linked.map.Node(self__.value,self__.left,self__.right,G__13020,self__.__extmap,self__.__hash));
});
...
linked.map.map__GT_Node = (function linked$map$map__GT_Node(G__13022){
return (new linked.map.Node(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__13022),new cljs.core.Keyword(null,"left","left",-399115937).cljs$core$IFn$_invoke$arity$1(G__13022),new cljs.core.Keyword(null,"right","right",-452581833).cljs$core$IFn$_invoke$arity$1(G__13022),null,cljs.core.dissoc.call(null,G__13022,new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"left","left",-399115937),new cljs.core.Keyword(null,"right","right",-452581833)),null));
});
...
return (function linked$map$iter__13032(s__13033){
return (new cljs.core.LazySeq(null,((function (coll){
return (function (){
var s__13033__$1 = s__13033;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__13033__$1);
if(temp__4425__auto__){
var s__13033__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__13033__$2)){
var c__5759__auto__ = cljs.core.chunk_first.call(null,s__13033__$2);
var size__5760__auto__ = cljs.core.count.call(null,c__5759__auto__);
var b__13035 = cljs.core.chunk_buffer.call(null,size__5760__auto__);
if((function (){var i__13034 = (0);
while(true){
if((i__13034 < size__5760__auto__)){
var vec__13038 = cljs.core._nth.call(null,c__5759__auto__,i__13034);
var k = cljs.core.nth.call(null,vec__13038,(0),null);
var v = cljs.core.nth.call(null,vec__13038,(1),null);
cljs.core.chunk_append.call(null,b__13035,[cljs.core.str(k),cljs.core.str(" "),cljs.core.str(v)].join(''));

var G__13040 = (i__13034 + (1));
i__13034 = G__13040;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13035),linked$map$iter__13032.call(null,cljs.core.chunk_rest.call(null,s__13033__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13035),null);
}
} else {
var vec__13039 = cljs.core.first.call(null,s__13033__$2);
var k = cljs.core.nth.call(null,vec__13039,(0),null);
var v = cljs.core.nth.call(null,vec__13039,(1),null);
return cljs.core.cons.call(null,[cljs.core.str(k),cljs.core.str(" "),cljs.core.str(v)].join(''),linked$map$iter__13032.call(null,cljs.core.rest.call(null,s__13033__$2)));
}
} else {
return null;
}
...
return (function (p1__13029_SHARP_,p2__13030_SHARP_){
return cljs.core.apply.call(null,cljs.core.partial.call(null,f,p1__13029_SHARP_),p2__13030_SHARP_);
});})(coll__$1))
...
linked.map.LinkedMap.prototype.apply = (function (self__,args13031){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args13031)));
});
...
var vec__13045 = cljs.core.find.call(null,delegate_map,current);
var k = cljs.core.nth.call(null,vec__13045,(0),null);
var node = cljs.core.nth.call(null,vec__13045,(1),null);
...
return cljs.core.cons.call(null,entry,(new cljs.core.LazySeq(null,((function (vec__13045,k,node,entry,next){
return (function (){
return linked$map$visit_node.call(null,delegate_map,next,last,direction);
});})(vec__13045,k,node,entry,next))
,null,null)));
}
});
