...
linked.map.Node.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5605__auto__,k12985,else__5606__auto__){
var self__ = this;
var this__5605__auto____$1 = this;
var G__12987 = (((k12985 instanceof cljs.core.Keyword))?k12985.fqn:null);
switch (G__12987) {
case "value":
return self__.value;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k12985,else__5606__auto__);
...
linked.map.Node.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5610__auto__,k__5611__auto__,G__12984){
var self__ = this;
var this__5610__auto____$1 = this;
var pred__12988 = cljs.core.keyword_identical_QMARK_;
var expr__12989 = k__5611__auto__;
if(cljs.core.truth_(pred__12988.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__12989))){
return (new linked.map.Node(G__12984,self__.left,self__.right,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__12988.call(null,new cljs.core.Keyword(null,"left","left",-399115937),expr__12989))){
return (new linked.map.Node(self__.value,G__12984,self__.right,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__12988.call(null,new cljs.core.Keyword(null,"right","right",-452581833),expr__12989))){
return (new linked.map.Node(self__.value,self__.left,G__12984,self__.__meta,self__.__extmap,null));
} else {
return (new linked.map.Node(self__.value,self__.left,self__.right,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5611__auto__,G__12984),null));
}
}
}
});
...
linked.map.Node.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5602__auto__,G__12984){
var self__ = this;
var this__5602__auto____$1 = this;
return (new linked.map.Node(self__.value,self__.left,self__.right,G__12984,self__.__extmap,self__.__hash));
});
...
linked.map.map__GT_Node = (function linked$map$map__GT_Node(G__12986){
return (new linked.map.Node(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__12986),new cljs.core.Keyword(null,"left","left",-399115937).cljs$core$IFn$_invoke$arity$1(G__12986),new cljs.core.Keyword(null,"right","right",-452581833).cljs$core$IFn$_invoke$arity$1(G__12986),null,cljs.core.dissoc.call(null,G__12986,new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"left","left",-399115937),new cljs.core.Keyword(null,"right","right",-452581833)),null));
});
...
return (function linked$map$iter__12996(s__12997){
...
var c__5759__auto__ = cljs.core.chunk_first.call(null,s__12997__$2);
var size__5760__auto__ = cljs.core.count.call(null,c__5759__auto__);
var b__12999 = cljs.core.chunk_buffer.call(null,size__5760__auto__);
if((function (){var i__12998 = (0);
while(true){
if((i__12998 < size__5760__auto__)){
var vec__13002 = cljs.core._nth.call(null,c__5759__auto__,i__12998);
var k = cljs.core.nth.call(null,vec__13002,(0),null);
var v = cljs.core.nth.call(null,vec__13002,(1),null);
cljs.core.chunk_append.call(null,b__12999,[cljs.core.str(k),cljs.core.str(" "),cljs.core.str(v)].join(''));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__12999),linked$map$iter__12996.call(null,cljs.core.chunk_rest.call(null,s__12997__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__12999),null);
}
} else {
var vec__13003 = cljs.core.first.call(null,s__12997__$2);
var k = cljs.core.nth.call(null,vec__13003,(0),null);
var v = cljs.core.nth.call(null,vec__13003,(1),null);
return cljs.core.cons.call(null,[cljs.core.str(k),cljs.core.str(" "),cljs.core.str(v)].join(''),linked$map$iter__12996.call(null,cljs.core.rest.call(null,s__12997__$2)));
}
} else {
return null;
}
...
return (function (p1__12993_SHARP_,p2__12994_SHARP_){
return cljs.core.apply.call(null,cljs.core.partial.call(null,f,p1__12993_SHARP_),p2__12994_SHARP_);
});})(coll__$1))
...
var G__13005 = cljs.core._assoc.call(null,ret,cljs.core._nth.call(null,e,(0)),cljs.core._nth.call(null,e,(1)));
var G__13006 = cljs.core.next.call(null,es);
ret = G__13005;
es = G__13006;
continue;
} else {
...
var G__13007 = null;
var G__13007__2 = (function (self__,k){
var self__ = this;
var self____$1 = this;
var coll = self____$1;
return cljs.core._lookup.call(null,coll,k);
});
var G__13007__3 = (function (self__,k,not_found){
var self__ = this;
var self____$1 = this;
var coll = self____$1;
return cljs.core._lookup.call(null,coll,k,not_found);
});
G__13007 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__13007__2.call(this,self__,k);
case 3:
return G__13007__3.call(this,self__,k,not_found);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__13007.cljs$core$IFn$_invoke$arity$2 = G__13007__2;
G__13007.cljs$core$IFn$_invoke$arity$3 = G__13007__3;
return G__13007;
})()
;

linked.map.LinkedMap.prototype.apply = (function (self__,args12995){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args12995)));
});
...
var vec__13009 = cljs.core.find.call(null,delegate_map,current);
var k = cljs.core.nth.call(null,vec__13009,(0),null);
var node = cljs.core.nth.call(null,vec__13009,(1),null);
...
return cljs.core.cons.call(null,entry,(new cljs.core.LazySeq(null,((function (vec__13009,k,node,entry,next){
return (function (){
return linked$map$visit_node.call(null,delegate_map,next,last,direction);
});})(vec__13009,k,node,entry,next))
,null,null)));
}
});
