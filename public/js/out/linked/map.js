...
linked.map.Node.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5605__auto__,k13065,else__5606__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k13065,else__5606__auto__);
...
linked.map.Node.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5610__auto__,k__5611__auto__,G__13064){
var self__ = this;
var this__5610__auto____$1 = this;
var pred__13068 = cljs.core.keyword_identical_QMARK_;
var expr__13069 = k__5611__auto__;
if(cljs.core.truth_(pred__13068.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__13069))){
return (new linked.map.Node(G__13064,self__.left,self__.right,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__13068.call(null,new cljs.core.Keyword(null,"left","left",-399115937),expr__13069))){
return (new linked.map.Node(self__.value,G__13064,self__.right,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__13068.call(null,new cljs.core.Keyword(null,"right","right",-452581833),expr__13069))){
return (new linked.map.Node(self__.value,self__.left,G__13064,self__.__meta,self__.__extmap,null));
} else {
return (new linked.map.Node(self__.value,self__.left,self__.right,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5611__auto__,G__13064),null));
}
}
}
});
...
linked.map.Node.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5602__auto__,G__13064){
var self__ = this;
var this__5602__auto____$1 = this;
return (new linked.map.Node(self__.value,self__.left,self__.right,G__13064,self__.__extmap,self__.__hash));
});
...
linked.map.map__GT_Node = (function linked$map$map__GT_Node(G__13066){
return (new linked.map.Node(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__13066),new cljs.core.Keyword(null,"left","left",-399115937).cljs$core$IFn$_invoke$arity$1(G__13066),new cljs.core.Keyword(null,"right","right",-452581833).cljs$core$IFn$_invoke$arity$1(G__13066),null,cljs.core.dissoc.call(null,G__13066,new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"left","left",-399115937),new cljs.core.Keyword(null,"right","right",-452581833)),null));
});
...
return (function linked$map$iter__13076(s__13077){
return (new cljs.core.LazySeq(null,((function (coll){
return (function (){
var s__13077__$1 = s__13077;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__13077__$1);
if(temp__4425__auto__){
var s__13077__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__13077__$2)){
var c__5759__auto__ = cljs.core.chunk_first.call(null,s__13077__$2);
var size__5760__auto__ = cljs.core.count.call(null,c__5759__auto__);
var b__13079 = cljs.core.chunk_buffer.call(null,size__5760__auto__);
if((function (){var i__13078 = (0);
while(true){
if((i__13078 < size__5760__auto__)){
var vec__13082 = cljs.core._nth.call(null,c__5759__auto__,i__13078);
var k = cljs.core.nth.call(null,vec__13082,(0),null);
var v = cljs.core.nth.call(null,vec__13082,(1),null);
cljs.core.chunk_append.call(null,b__13079,[cljs.core.str(k),cljs.core.str(" "),cljs.core.str(v)].join(''));

var G__13084 = (i__13078 + (1));
i__13078 = G__13084;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13079),linked$map$iter__13076.call(null,cljs.core.chunk_rest.call(null,s__13077__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13079),null);
}
} else {
var vec__13083 = cljs.core.first.call(null,s__13077__$2);
var k = cljs.core.nth.call(null,vec__13083,(0),null);
var v = cljs.core.nth.call(null,vec__13083,(1),null);
return cljs.core.cons.call(null,[cljs.core.str(k),cljs.core.str(" "),cljs.core.str(v)].join(''),linked$map$iter__13076.call(null,cljs.core.rest.call(null,s__13077__$2)));
}
} else {
return null;
}
...
return cljs.core.apply.call(null,cljs.core.partial.call(null,f,p1__13073_SHARP_),p2__13074_SHARP_);
});})(coll__$1))
...
var G__13085 = cljs.core._assoc.call(null,ret,cljs.core._nth.call(null,e,(0)),cljs.core._nth.call(null,e,(1)));
var G__13086 = cljs.core.next.call(null,es);
ret = G__13085;
es = G__13086;
continue;
} else {
...
var G__13087 = null;
var G__13087__2 = (function (self__,k){
var self__ = this;
var self____$1 = this;
var coll = self____$1;
return cljs.core._lookup.call(null,coll,k);
});
var G__13087__3 = (function (self__,k,not_found){
var self__ = this;
var self____$1 = this;
var coll = self____$1;
...
G__13087.cljs$core$IFn$_invoke$arity$2 = G__13087__2;
G__13087.cljs$core$IFn$_invoke$arity$3 = G__13087__3;
return G__13087;
})()
;

linked.map.LinkedMap.prototype.apply = (function (self__,args13075){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args13075)));
});
...
var vec__13089 = cljs.core.find.call(null,delegate_map,current);
var k = cljs.core.nth.call(null,vec__13089,(0),null);
var node = cljs.core.nth.call(null,vec__13089,(1),null);
...
return cljs.core.cons.call(null,entry,(new cljs.core.LazySeq(null,((function (vec__13089,k,node,entry,next){
return (function (){
return linked$map$visit_node.call(null,delegate_map,next,last,direction);
});})(vec__13089,k,node,entry,next))
,null,null)));
}
});
