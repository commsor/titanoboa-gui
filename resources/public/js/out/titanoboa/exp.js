...
*/
titanoboa.exp.Expression = (function (value,__meta,__extmap,__hash){
this.value = value;
this.__meta = __meta;
...
;
return cljs.core.pr_sequential_writer.call(null,writer__5618__auto__,pr_pair__5620__auto__,"#titanoboa.exp.Expression{",", ","}",opts__5619__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"value","value",305978217),self__.value],null))], null),self__.__extmap));
});
...
return (new cljs.core.RecordIter((0),G__7297__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
return (new titanoboa.exp.Expression(self__.value,self__.__meta,self__.__extmap,self__.__hash));
});
...
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),null], null), null),k__5613__auto__)){
...
return (new titanoboa.exp.Expression(self__.value,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__5613__auto__)),null));
}
});
...
return (new titanoboa.exp.Expression(G__7297,self__.__meta,self__.__extmap,null));
} else {
return (new titanoboa.exp.Expression(self__.value,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5611__auto__,G__7297),null));
}
});
...
return (new titanoboa.exp.Expression(self__.value,G__7297,self__.__extmap,self__.__hash));
});
...
titanoboa.exp.__GT_Expression = (function titanoboa$exp$__GT_Expression(value){
return (new titanoboa.exp.Expression(value,null,null,null));
});

titanoboa.exp.map__GT_Expression = (function titanoboa$exp$map__GT_Expression(G__7299){
return (new titanoboa.exp.Expression(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__7299),null,cljs.core.dissoc.call(null,G__7299,new cljs.core.Keyword(null,"value","value",305978217)),null));
});

titanoboa.exp.read_expression = (function titanoboa$exp$read_expression(expr){
if(typeof expr === 'string'){
return (new titanoboa.exp.Expression(expr));
} else {
return (new titanoboa.exp.Expression(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(expr)));
}
});
titanoboa.exp.transit_write_handler = cognitect.transit.write_handler.call(null,cljs.core.constantly.call(null,"titanoboa.exp.Expression"),(function (p1__7305_SHARP_){
return new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__7305_SHARP_);
}));
titanoboa.exp.transit_read_handler = cognitect.transit.read_handler.call(null,(function (p1__7306_SHARP_){
return titanoboa.exp.read_expression.call(null,p1__7306_SHARP_);
}));
titanoboa.exp.edn_reader_map = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Symbol("titanoboa.exp","Expression","titanoboa.exp/Expression",-989257386,null),new cljs.core.Var(function(){return titanoboa.exp.read_expression;},new cljs.core.Symbol("titanoboa.exp","read-expression","titanoboa.exp/read-expression",-1994303152,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[new cljs.core.Symbol(null,"titanoboa.exp","titanoboa.exp",754517708,null),new cljs.core.Symbol(null,"read-expression","read-expression",-2019647824,null),"src/cljs/titanoboa/exp.cljs",22,null,null,6,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"expr","expr",-1908713478,null)], null)),null,(cljs.core.truth_(titanoboa.exp.read_expression)?titanoboa.exp.read_expression.cljs$lang$test:null)]))], null);
