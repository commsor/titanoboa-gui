...
return cljs.core.swap_BANG_.call(null,user,cljs.core.assoc,new cljs.core.Keyword(null,"name","name",1843675177),p1__10940_SHARP_.target.value);
});})(user))
...
return cljs.core.swap_BANG_.call(null,user,cljs.core.assoc,new cljs.core.Keyword(null,"password","password",417022471),p1__10941_SHARP_.target.value);
});})(user))
...
return cljs.core.reset_BANG_.call(null,titanoboa.core.user_data,p1__10942_SHARP_);
});})(user))
);
...
titanoboa.api.get_user.call(null,(function (p1__10943_SHARP_){
return cljs.core.reset_BANG_.call(null,titanoboa.core.user_data,p1__10943_SHARP_);
}));
titanoboa.core.load_data.call(null);
